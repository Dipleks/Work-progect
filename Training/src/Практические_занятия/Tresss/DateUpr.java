...
public interface DateUpr {
    ...
    default DatePicker getD1 () {
        ...
        d1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ld1.setText(String.valueOf(d1.getValue().format(DateTimeFormatter.ofPattern("EE, dd MMMM uuuu"))) + " года");
            }
        });
        return d1;
    }
    ...
    default DatePicker getD2 () {
        ...
        d2.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                ld2.setText(String.valueOf(d2.getValue().format(DateTimeFormatter.ofPattern("EE, dd MMMM uuuu"))) + " года");
            }
        });
        return d2;
    }
    ...
    default DatePicker getD3 () {
        ...
        d3.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                ld3.setText(String.valueOf(d3.getValue().format(DateTimeFormatter.ofPattern("EE, dd MMMM uuuu"))) + " года");
            }
        });
        return d3;
    }
